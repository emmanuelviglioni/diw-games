...
// função de pesquisa + paginação
function pesquisar(nPage) {
    if (!nPage) {
        nPage = 1
    }
    // Função para pegar os dados dos jogos baseado naquilo que foi pesquisado e colocar dentro de cards
...
// Função de fazer a pesquisa usando o enter
